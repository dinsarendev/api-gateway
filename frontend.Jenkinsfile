pipeline {
    ...
    environment {
        PROJECT_SERVICE  = "API GATEWAY ADMIN SERVICE 🗃️"
        GIT_BRANCH = "develop"
        ...
        MANIFEST_FOLDER = "dev/overlays/gateway-admin/patches"
        SERVICE_PATCH = "api-gateway-admin-service-patch.yaml"

        IMAGE_REGISTRY = "nexus.cambofreelance.com/docker-hosted"
        FOLDER_REGISTRY = "ms/dev"
        IMAGE_NAME = "api-gateway-admin-service"
