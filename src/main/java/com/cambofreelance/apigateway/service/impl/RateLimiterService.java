...
public class RateLimiterService {
    ...
    public RateLimiterService(StringRedisTemplate stringRedisTemplate, ApiRouteManagerRedisCache apiRouteManagerRedisCache) {
        this.stringRedisTemplate = stringRedisTemplate;
        this.apiRouteManagerRedisCache = apiRouteManagerRedisCache;
    }

    /**g
     * Check if request is allowed based on:
     * - Public API -> use clientIp
